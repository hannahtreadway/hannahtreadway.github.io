...
**About:** This course introduces graduate and advanced undergraduate students to corpus-based approaches for investigating language, with a particular focus on multilingual contexts, code-switching, and language contact ecologies. Using the metaphor of the linguist’s kitchen, participants learn to select, prepare, and analyze linguistic data across modalities and contexts, including spoken interaction and multilingual corpora. The course then connects corpus methods with experimental approaches to examine how patterns of language use relate to multilingual language processing and behavior. Through hands-on analysis of real bilingual data and the design of a small-scale research project, participants develop practical skills for formulating research questions, selecting appropriate methods, and drawing evidence-based conclusions about multilingual language use. For more information, consult the [course website](https://gramatica.usc.es/cursos/verano2026/es).
...
## IDS 2935: Multilingual AI (Honors)
**Role:** TA
