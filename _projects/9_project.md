...
While data collection for this study is currently underway, we hypothesize that due to the repeated exposure to the Spanish phonological system in learning Spanish, the Rosetta Stone group will produce English word-initial /p,t,k/ with a shorter lag VOT than the control group after language training period. **(Presented at [FPM2025](https://mll.fsu.edu/event/florida-psycholinguistics-meeting-2025) and [UF Spring Undergraduate Research Symposium](https://www.oconnellcenter.ufl.edu/events/uf-spring-undergraduate-research-symposium/).)**
